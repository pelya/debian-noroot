...
sudo qemu-debootstrap --arch=armhf --verbose \
        ...
        --include=fakeroot,fakechroot,xfonts-base,x11-xserver-utils,xfce4-panel,xfdesktop4,xfwm4,xfce4-session,thunar,xfconf,xfce4-settings,tango-icon-theme,apt,synaptic,apt-xapian-index \
