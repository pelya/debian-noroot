...
export LD_LIBRARY_PATH=`pwd`/usr/local/lib:`pwd`/usr/lib/arm-linux-gnueabi:`pwd`/usr/lib:`pwd`/lib/arm-linux-gnueabi:`pwd`/lib:/system/lib:/usr/local/lib:/usr/lib/arm-linux-gnueabi:/usr/lib:/lib/arm-linux-gnueabi:/lib:`pwd`/usr/lib/arm-linux-gnueabi/libfakeroot:`pwd`
export "LD_PRELOAD=`pwd`/libfakechroot.so libfakedns.so"
