...
sudo qemu-debootstrap --arch=armel --verbose \
        ...
        --include=ubuntu-minimal,fakeroot,fakechroot,xfonts-base,tightvncserver,synaptic,socat,putty,xfce4-panel,xfce4-session,xfce4-utils,xfdesktop4,xfwm4,gimp,abiword,gnumeric \
